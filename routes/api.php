...
Route::group([
    ...
    Route::put('updateStatusNotify/{id}', [NotificationsController::class, 'updateNotificationStatus']);
    Route::put('updateMessageNotify/{id}', [NotificationsController::class, 'updateNotificationMessage']);
    Route::post('noNotification', [NotificationsController::class, 'noNotificationMessage']);
    Route::post('deleteNoNotification', [NotificationsController::class, 'deleteNotify']);
});
